...
def add_shared_arguments(parser: argparse.ArgumentParser) -> None:
    """Add shared arguments to the given ArgumentParser"""
...
def load_clang_tidy_warnings() -> Any:
...
# NOTE: Could be a typeddict
def load_review() -> PRReview:
