...
- `post_comments`: Boolean value describing whether or not to actually post the review from this workflow. If set to false, can be accompanied by the post_comments child workflow.
  - default: true
...
jobs:
  build:
    ...
    steps:
      ...
      - uses: ZedThree/clang-tidy-review/post_comments@v0.8.0
```
